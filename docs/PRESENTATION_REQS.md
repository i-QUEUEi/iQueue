...
**File:** [evaluation.py](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/evaluation.py)

Three separate evaluation strategies are combined into a single **`robust_mae`** score:

| Strategy | Lines | What it does |
|---|---|---|
| Random split | [L48–49](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/evaluation.py#L48-L49) | Trains on `X_train`, tests on `X_test` |
| Chronological split | [L51–53](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/evaluation.py#L51-L53) | Trains on earliest 80% of dates, tests on latest 20% |
| 5-Fold Cross-Validation | [L55–66](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/evaluation.py#L55-L66) | Shuffled KFold, scoring MAE + RMSE + R² |
...
Error percentiles are also captured at [L77–80](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/evaluation.py#L77-L80):
```python
...
The chronological split logic lives in [splits.py](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/splits.py) — sorts by date, then cuts at 80% of unique dates ([L9–16](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/splits.py#L9-L16)).

---

## 2. ✅ Data Evaluation

**File:** [evaluation.py — L137–155](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/evaluation.py#L137-L155)
...
**File:** [plots.py](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/plots.py)

| Plot | Function | Lines | Output file |
|---|---|---|---|
| Waiting time distribution | `plot_target_distribution()` | [L8–16](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/plots.py#L8-L16) | `outputs/plots/target_distribution.png` |
| Day × Hour heatmap | `plot_day_hour_heatmap()` | [L19–37](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/plots.py#L19-L37) | `outputs/plots/day_hour_heatmap.png` |
| Model comparison bar chart | `plot_model_comparison()` | [L40–56](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/plots.py#L40-L56) | `outputs/plots/model_comparison.png` |
| Actual vs Predicted scatter | `plot_actual_vs_predicted()` | [L59–69](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/plots.py#L59-L69) | `outputs/plots/actual_vs_predicted.png` |
...
**File:** [reporting.py — L60–73](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/reporting.py#L60-L73)
...
Feature importance rankings are also printed right after at [L75–77](file:///c:/Users/Rhenel%20Jhon%20Sajol/Documents/IQUEUE/iQueue/src/Evaluation/reporting.py#L75-L77), further backing up the "why these features" story.
